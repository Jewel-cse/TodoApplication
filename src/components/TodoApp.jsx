            ...
            <div className="container">
                <div className="row">
                    <nav className="navbar navbar-expand-lg">
                        <a className="navbar-brand ms-2 fs-2 fw-bold text-black" href="https://www.jewel.com">jewel.com</a>
                        <div className="collapse navbar-collapse">
                            <ul className="navbar-nav">
                                <li className="nav-item fs-5"><Link className="nav-link" to="/welcome/jewel">Home</Link></li>
...
export function LogoutComponent() {
  return (
    <div>
      ...
      <div className="logout">Thanks for using our App</div>
    </div>
  );
}
